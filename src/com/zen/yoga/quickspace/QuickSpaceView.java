 ...
 */
package com.zen.yoga.quickspace;
...
import com.zen.yoga.quickspace.QuickspaceController.OnDataListener;
import com.zen.yoga.quickspace.receivers.QuickSpaceActionReceiver;
import com.zen.yoga.views.DateTextView;
...
public class QuickSpaceView extends FrameLayout implements AnimatorUpdateListener, Runnable, OnDataListener {
    ...
    public final void bindWeather(View container, TextView title, ImageView icon) {
        boolean hasGoogleApp = Bits.hasPackageInstalled(Launcher.getLauncher(mContext), YogaLauncherCallbacks.SEARCH_PACKAGE);
        mWeatherAvailable = mController.isWeatherAvailable();
